...
Shader::Shader(const std::string vertexFilepath, const std::string fragmentFilepath, const std::string shaderName)
	:vertexShaderPath(vertexFilepath), fragmentShaderPath(fragmentFilepath), shaderName(shaderName)
{
}
